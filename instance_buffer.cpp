...
void paz::InstanceBuffer::Data::checkSize(int dim, std::size_t size)
{
    ...
    {
        throw std::runtime_error("Instance attribute dimensions must be 1, 2, or 4.");
    }
    ...
    {
        throw std::runtime_error("Number of instances for each attribute must match.");
    }
}

void paz::InstanceBuffer::attribute(int dim, const GLfloat* data, std::size_t
    size)
{
...
void paz::InstanceBuffer::attribute(int dim, const GLuint* data, std::size_t size)
{
    _data->checkSize(dim, size);
...
void paz::InstanceBuffer::attribute(int dim, const GLint* data, std::size_t size)
{
    _data->checkSize(dim, size);
    ...
    switch(dim)
    {
        ...
        default: throw std::logic_error("Instance attribute dimensions must be 1, 2, or 4.");
    }
